...
Node* list_search_by_name(LinkedList* l, char* search_name)
{
    if (search_name)
    {
        ...
        while(r)
        {
            int get = compare((r -> data) -> name, search_name);
            if (get == 0)
                break;
            r = r -> next;
        }
...
int list_search_by_score(LinkedList* l, float lower_bound, float upper_bound, char* result[RES_SIZE])
{
    ...
    int i = 0;
        while(r)
        {
            if ((((r -> data) -> score) >= lower_bound) && (((r -> data) -> score) <= upper_bound))
            {
                result[i] = ((r -> data) -> name);
                i += 1;
            }
            r = r -> next;
        }
...
//part3333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333
//function mainnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn
int main()
{
